...
public class Mobile extends MudThing {
	...
	public Mobile(int vnum, Model model, int copyFrom) {
		...
		hitDice = new Dice(temp.getHitDice().getNumberOfDice(), temp.getHitDice().getNumberOfSides(),
				temp.getHitDice().getBonus());
		manaDice = new Dice(temp.getManaDice().getNumberOfDice(), temp.getManaDice().getNumberOfSides(),
				temp.getManaDice().getBonus());
		damageDice = new Dice(temp.getDamageDice().getNumberOfDice(), temp.getDamageDice().getNumberOfSides(),
	...
	public void setShop(MudShopView s) {
		myShop = s;
	}

	public void addShop() {
		myShop = new MudShopView(vnum);
	}
	...
	public String toString() {
		if (getShop() == null)
			...
			return Integer.toString(vnum) + " " + getShortDesc() + "   [ShopKeeper]";
	}
	...
	public MobileProgram getMobProg() {
		return mobprog;
	}
}
