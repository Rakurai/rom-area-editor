...
public class MudShopView {
	...
	public String toString() {
		String temp;
		temp = intToString(keeper) + " " + intToString(buyType[0]) + " " + intToString(buyType[1]) + " "
				+ intToString(buyType[2]);
	...
	public JPanel getPanel() {
		...
		JLabel label = new JLabel("This mobile will sell the equipment selected in it's inventory.");
