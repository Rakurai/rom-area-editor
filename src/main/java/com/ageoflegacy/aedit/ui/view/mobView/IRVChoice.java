...
public class IRVChoice extends JPanel {
	 ...
	 * @param name
	 *            array of names to set as labels
	 * @param data
	 *            array of flag values each name represents
	 * @param c
	 *            the size of names/data<BOLD>(SHOULD BE THE SAME!)</BOLD>
	 */
	...
	private void setupLayout() {
		try {
			...
			for (int a = 0; a < arraySize; a++) {
				...
				SpringUtilities.makeCompactGrid(choicePanel, 1, choicePanel.getComponentCount(), 0, 0, 0, 0);
	...
	/**
	 * Given an integer bit flags, looks up the matching item in the classes
	 * array of flags.
	 */
	...
	/**
	 * Disable a certain check box in the layout. - flag is an integer bit flag.
	 */
	...
	/**
	 * Enable a certain check box in the layout. - flag is an integer bit flag.
	 */
