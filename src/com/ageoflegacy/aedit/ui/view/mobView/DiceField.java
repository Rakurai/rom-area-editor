...
import com.ageoflegacy.aedit.ui.view.mobView.DiceForm;
...
/**
 * Displays a Dice as a set of three text fields representing the number of
 * dice, the number of sides on each dice and a bonus to add to the roll. The
 * bonus may be negative or 0.
 */
public class DiceField extends JPanel implements FocusListener {

	private JTextField number, sided, bonus;
	private String name;
	private com.ageoflegacy.aedit.ui.view.mobView.DiceForm target;
	 ...
	 *
	 * @param name
	 *            An alias to name this dice
	 * @param target
	 *            The target DiceForm to call on changes.
	 */
	...
	/**
	 * Called when any of the JTextFields gain focus. Copy the current Dice for
	 * later
	 *
	 * @param event
	 *            FocusEvent
	...
	public void focusGained(FocusEvent event) {
		...
		currentValue = new Dice(Integer.parseInt(number.getText()), Integer.parseInt(sided.getText()),
				Integer.parseInt(bonus.getText()));

	}

	/**
	 * Called when any of the JTextFields lose focus. Compare new dice value and
	 * update as needed.
	 *
	 * @param event
	 *            FocusEvent
	...
	public void focusLost(FocusEvent event) {
		...
		if (newNumber == currentValue.getNumberOfDice() && newSided == currentValue.getNumberOfSides()
